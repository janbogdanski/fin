...
| BETA-BLK-002 | Release Discipline | Brak potwierdzonej strategii `release branch/tag -> CI -> deploy` na właściwej linii releasowej | Zielony `main` nie jest tym samym co zielony kandydat do releasu | Tech Lead | READY FOR VERIFY | `v0.1.0-rc.1` wypchnięty 2026-04-15 (commit `78a81d5`); `release.yml` uruchomiony — sprawdź wynik na GitHub Actions | Jest release branch/tag policy, a CI i deploy są sprawdzone na tagu RC | Zweryfikować wynik release.yml na GitHub Actions i dodać evidence tutaj |
